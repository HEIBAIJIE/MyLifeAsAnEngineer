...
- 可执行"沟通发展路径"，触发事件60
- 满足老板不满度>70且理性>60，可执行"幻想跳槽"，触发事件500（新增）
...
1. 速食面 - 价格12，饥饿度-15
2. 健康餐盒 - 价格35，饥饿度-25，健康度+3
3. 咖啡 - 价格18，疲劳度-10，专注力+10
4. 功能饮料 - 价格15，疲劳度-15，健康度-1，专注力+5
5. 营养餐 - 价格55，饥饿度-30，健康度+5
6. 维生素 - 价格120，健康度+10
7. 纯净水 - 价格5，健康度+2
8. 水果 - 价格25，饥饿度-12，健康度+3，感性+2

### 工具类物品（可放入柜子）

1. 技术手册 - 价格200，使用后专业技能+(4+理性/15)
2. 学习资料 - 价格150，使用后理性+(4+专业技能/20)
3. 运动器材 - 价格350，使用后健康度+8，疲劳度+5
4. 工作设备 - 价格1200，工作效率永久提升15%
5. 按摩设备 - 价格600，使用后疲劳度-15，专注力+8
6. 娱乐设备 - 价格800，使用后心情+(10+感性/8)
7. 办公用品 - 价格120，工作专注力消耗-15%
8. 健康设备 - 价格800，每天自动恢复健康度+3
...
3. 事件87，摸鱼看内网论坛，消耗时间3，心情+5，专注力-3，返回文本57
...
8. 事件92，学习业界实践，消耗时间4，专注力消耗12，专业技能+4*(1+理性/25)，理性+2，返回文本62
...
500. 事件500，幻想跳槽，消耗时间2，心情+5，理性+3，返回随机幽默文本
...
1. 事件120，吃工作餐，消耗时间2，饥饿度-25，钱-20，返回文本90
2. 事件121，和同事共进午餐，消耗时间3，饥饿度-25，感性+5，同事好感度+2，钱-25，返回文本91
3. 事件122，独自用餐，消耗时间2，饥饿度-25，理性+2，钱-20，返回文本92
4. 事件123，了解食堂菜品，消耗时间1，感性+2，返回文本93

### 商店相关事件（124-133）

1. 事件124，询问商品信息，消耗时间2，理性+2，返回文本94
2. 事件125，购买生活用品，消耗时间2，钱-150，心情+3，返回文本95
3. 事件126，购买工作用品，消耗时间2，钱-300，专注力+5，返回文本96
...
1. 事件177，点餐，消耗时间2，饥饿度-35，钱-120，返回文本147
...
1. 事件188，常规体检，消耗时间4，健康度+15，钱-500，返回文本158
2. 事件189，咨询健康问题，消耗时间3，健康度+5，理性+3，钱-200，返回文本159
3. 事件190，定期健康管理，消耗时间5，健康度+20，钱-800，返回文本160
...
1. 发薪水。每周日24点触发。薪水=(5000+800*职级)*(100-老板不满度/2)/100。返回文本193
2. 交房租。每月1日24点触发。房租4500。钱>=4500返回文本194，否则触发结局5
...
5. 生活开销。每天24点触发。钱-80（基本生活费），返回文本208
